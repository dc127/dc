...
<div class="width1198 center_yh" style="height:35px;background:#f0f0f0;border:1px solid #ddd;margin-top:25px;">
    ...
    <a href="javascript:void(0)" class="mR" name="price_desc">价格<img src="images/gg.png"></a>
    <a href="javascript:void(0)" class="mR" name="product_desc">销量<img src="images/gg.png"></a>
    <script>
    	$(".mR").click(function(){
            ...
            success : function(res){
                ...
                for(var i=0;i<list.length;i++){
                    ...
                    $(".listSs").append("<li>\n" +
                        ...
                        "                <font class=\"right_yh c_66 font14\">156人已买</font>\n" +
                        "            </p>\n" +
                      /*  "            <div class=\"wCa\">\n" +
                        "            \t<div class=\"wCa1\">\n" +
