...
<div class="width1200 center_yh hidden_yh" style="height:420px;">
	<div class="left_yh" style="width:350px;height:420px;">
		...
		<div id="preview">
				<div class=jqzoom id="spec-n1" onClick="window.open('/')">
                	<IMG height="350" src="${requestScope.gift.gift_img}" jqimg="images/T1CtvCXaFjXXcVIIsU_014122.jpg" width="350">
				</div>
					<div id="spec-n5">
						...
						<div id="spec-list">
							<ul class="list-h">
								<li><img src="${requestScope.gift.gift_img}"></li>
    ...
    <div class="left_yh" style="width:486px;height:420px;margin-left:42px;">
    	<h3 class="font20 font100">${requestScope.gift.gift_name}</h3>
        ...
        <p class="font16 c_66 likeColor" style="margin-top:25px;">
            ...
            <font class="font14 c_99" style="margin-left:20px;">${requestScope.gift.gift_num}</font>
        	<script>
