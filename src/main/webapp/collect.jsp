...
<div class="width100 hidden_yh" style="background:#66c561;padding-top:34px;padding-bottom:34px;">
	<div class="width1200 hidden_yh center_yh">
    	<div id="vipNav">
            ...
            <a href="collect.jsp" class="on">商品收藏</a>
            ...
            <div class="hidden_yh bj_fff" style="width:938px;border:1px solid #ddd;">
                ...
                <div class="hidden_yh" style="padding:20px;width:898px;">
                    ...
                    <div class="width100 hidden_yh" style="border-bottom:1px dashed #ddd;padding-top:10px;padding-bottom:10px;">
                        ...
                        <div class="right_yh">
                        	<a href="javascript:void(0)" class="onfff block_yh tcenter font16" style="margin-top:10px;padding:6px;">加入购物车</a>
                            <a href="javascript:void(0)" class="onfff block_yh tcenter font16" style="margin-top:10px;padding:6px;">取消收藏</a>
                        </div>
                    </div>
                    <!--一条-->
                    <div class="width100 hidden_yh" style="border-bottom:1px dashed #ddd;padding-top:10px;padding-bottom:10px;">
